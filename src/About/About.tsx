        ...
        <div className="about-content">
          <div className="about-row">
            <div className="left-content">
              ...
              <p>Testing workflows. I’m a passionate software developer with a strong foundation in computer science and a focus on building efficient, scalable, and user-friendly applications. I enjoy solving complex problems through clean code and thoughtful design, whether working on the frontend, backend, or full-stack systems. With experience across a range of technologies and languages, I continuously seek to...</p>
