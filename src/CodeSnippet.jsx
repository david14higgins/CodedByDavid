...
const CodeSnippet = () => {
  return (
    <div>
      ...
      <p className="code-line"><span className="import">import </span> <span className="react">React</span>, &#123; <span className="builtin">useState</span>, <span className="builtin">useEffect</span> &#125; <span className="import">from </span> <span className="string">"react"</span>;</p>
      ...
      <p className="code-line">        &lt;div className=<span className="string">"app-container"</span>&gt;</p>
